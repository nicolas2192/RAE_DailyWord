...
def make_words_csv(csv_path: str):
    ...
    """
    # if there is no words.csv file this function will create it.
    with open(csv_path, "w") as new_file:
        ...
        print(f"New csv file added at the following path: {csv_path}\n")
...
def update_csv(date, word, meaning, csv_path: str):
    """
